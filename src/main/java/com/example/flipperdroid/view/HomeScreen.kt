...
fun HomeScreen(
    ...
    val features = listOf(
        ...
        FeatureItem("NDEF Emulator", Icons.Default.Nfc, "ndef_emulator",
        ...
        FeatureItem("Bluetooth Classic", Icons.Default.Bluetooth, "bt_classic",
        ...
        FeatureItem("IR Tools", Icons.Default.FlashOn, "ir_tools",
            "TV-B-Gone power-code blaster and command brute-forcer for mapping unknown remotes. Authorized testing only."),
        FeatureItem("AC Control", Icons.Default.AcUnit, "ac_control",
        ...
        FeatureItem("Packet Sniffer", Icons.Default.Router, "packet_sniffer",
